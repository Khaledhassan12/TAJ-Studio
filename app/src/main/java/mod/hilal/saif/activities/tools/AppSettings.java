...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences(ViewGroup content) {
        ...
        managersCategory.addLibraryItem(createPreference(R.drawable.ic_cat_ai, "Artificial Intelligence Manager", "Local & cloud AI — models, runtime, agent", new ActivityLauncher(new Intent(getApplicationContext(), pro.sketchware.ai.ui.AiManagerActivity.class))), true);
